...
public class EditPage extends FakeActivity implements OnClickListener, TextWatcher, Callback {
	...
	private void initPageView() {
		...
		int resId = cn.sharesdk.framework.utils.R.getBitmapRes(getContext(), "title_back");
		llTitle.setBackgroundResource(resId);
		llTitle.getBtnBack().setOnClickListener(this);
		resId = cn.sharesdk.framework.utils.R.getStringRes(getContext(), "multi_share");
		llTitle.getTvTitle().setText(resId);
		llTitle.getBtnRight().setVisibility(View.VISIBLE);
		resId = cn.sharesdk.framework.utils.R.getStringRes(getContext(), "share");
		...
		resId = cn.sharesdk.framework.utils.R.getBitmapRes(getContext(), "pin");
		...
		resId = cn.sharesdk.framework.utils.R.getBitmapRes(getContext(), "title_shadow");
		...
		resId = cn.sharesdk.framework.utils.R.getBitmapRes(getContext(), "share_tb_back");
		...
		if(!TextUtils.isEmpty(imagePath) && new File(imagePath).exists()){
			...
			resId = cn.sharesdk.framework.utils.R.getBitmapRes(getContext(), "btn_back_nor");
		...
		if(shareImage){
			...
			resId = cn.sharesdk.framework.utils.R.getBitmapRes(getContext(), "img_cancel");
		...
		resId = cn.sharesdk.framework.utils.R.getStringRes(getContext(), "share_to");
	...
	private void checkAtMth(LinearLayout llInput, String platform) {
		if ("SinaWeibo".equals(platform) || "TencentWeibo".equals(platform)
			...
			int resId = cn.sharesdk.framework.utils.R.getBitmapRes(getContext(), "btn_back_nor");
			...
			resId = cn.sharesdk.framework.utils.R.getStringRes(getContext(), "list_friends");
		...
		if (v.equals(llTitle.getBtnRight())) {
			...
			if (selected) {
				...
				int resId = cn.sharesdk.framework.utils.R.getStringRes(
						getContext(), "select_one_plat_at_least");
	...
	private Bitmap getPlatLogo(Platform plat) {
		...
		int resId = cn.sharesdk.framework.utils.R.getBitmapRes(activity, resName);
